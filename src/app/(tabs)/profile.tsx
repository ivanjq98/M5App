...
export default function ProfileScreen() {
  ...
  return (
    <ThemedView style={{ flex: 1 }}>
      <ScrollView contentContainerStyle={{ padding: 16, paddingTop: 60, paddingBottom: 100 }}>
        ...
        <View style={{ gap: 20 }}>
          ...
          <View>
            ...
            <View style={{ backgroundColor: themeColors.card, borderRadius: 12, paddingHorizontal: 16 }}>
              <TextInput
                style={{ color: themeColors.text, fontSize: 16, paddingVertical: 14, minHeight: 100 }}
                value={isEditing ? tempProfile.bio : profile.bio}
                onChangeText={(text) => setTempProfile(p => ({...p, bio: text}))}
                editable={isEditing}
                multiline
              />
            </View>
